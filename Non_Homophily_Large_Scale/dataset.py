...
from Non_Homophily_Large_Scale.load_data import load_twitch, load_fb100, load_twitch_gamer, DATAPATH
from Non_Homophily_Large_Scale.data_utils import rand_train_test_idx, even_quantile_labels, to_sparse_tensor, dataset_drive_url

from Non_Homophily_Large_Scale.homophily import our_measure, edge_homophily_edge_idx
...
def load_genius():
    filename = 'genius'
    dataset = NCDataset(filename)
    fulldata = scipy.io.loadmat(f'Non_Homophily_Large_Scale/data/genius.mat')
